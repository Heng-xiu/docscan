...
void EscherHeader::dump()
{
    ...
    wvlog << " recVer = " << std::hex << recVer << std::dec << std::endl;
    wvlog << " recInstance = " << std::hex << recInstance << std::dec << std::endl;
    wvlog << " recType = " << std::hex << recType << std::dec << std::endl;
    wvlog << " recLen = " << recLen << std::endl;
