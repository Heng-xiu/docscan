...
QString Guessing::fontToXML(const QString &fontName, const QString &typeName)
{
    ...
    } else if (fontNameWithoutTag.startsWith(QStringLiteral("Gautami"))) {
        license[QStringLiteral("type")] = QStringLiteral("proprietary"); /// Microsoft/Raghunath Joshi (Type Director), Omkar Shende
