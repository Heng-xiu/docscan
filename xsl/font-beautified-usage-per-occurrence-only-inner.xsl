...
<xsl:text>
total		</xsl:text>
<xsl:value-of select="count(/log/logitem/fileanalysis[@status='ok']/meta/fonts/font[@oninnerpage='yes'])" />
<xsl:text>	</xsl:text>
...
<xsl:if test="count(/log/logitem/fileanalysis[@status='ok']/meta/fonts/font[@oninnerpage='yes' and beautified=$cmpto])>0">
<xsl:text>
</xsl:text>
...
<xsl:text>	</xsl:text>
<xsl:value-of select="count(/log/logitem/fileanalysis[@status='ok']/meta/fonts/font[@oninnerpage='yes' and beautified=$cmpto])" />
<xsl:text>	</xsl:text>
<xsl:value-of select="count(/log/logitem/fileanalysis[@status='ok' and meta/fonts/font[@oninnerpage='yes']/beautified=$cmpto])" />
</xsl:if>
</xsl:for-each>
