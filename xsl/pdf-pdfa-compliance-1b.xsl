...
<!-- column header  -->
<xsl:text>filename	jhove-pdfa1b	verapdf-pdfa1b	pdfboxvalidator-pdfa1b	adobe-preflight	qoppa-pdfpreflight	pdftools-3heights	votes-pdfa1b</xsl:text>
...
<xsl:text>	</xsl:text>
<xsl:value-of select="count(/log/logitem/fileanalysis[@status='ok']/meta/adobepreflight[@pdfa1b='yes' or @pdfa1a='yes'])" />
<xsl:text>	</xsl:text>
...
<xsl:text>	</xsl:text>
<xsl:value-of select="count(/log/logitem/fileanalysis[@status='ok']/meta[jhove/profile/@pdfa1b='yes' or verapdf/@pdfa1b='yes' or pdfboxvalidator/@pdfa1b='yes' or adobepreflight/@pdfa1b='yes' or qoppapdfpreflight/@pdfa1b='yes' or threeheightspdfvalidator/@pdfa1b='yes'])" />
<xsl:text>
</xsl:text>
